...
实测：clinical v15.0 的 kicker "Chapter 05 · Safety" 因 section 内容溢出贴顶，文字顶部被裁 6px（用户肉眼可见"显示不全"）。validate.js 已能抓此问题——v15.3 起 P4 grade-gate.js 强制跑即可拦截，关键是**不能漏跑 grade-gate.js**。
